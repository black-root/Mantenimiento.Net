...
class dinamicForm extends HTMLElement {
    ...
    connectedCallback(){
            ...
            //console.log(elementos[i]);
                if(elementos[i].nodeName === 'BR'){
                    ...
                    if(elementos[i].name != null){
                        ...
                        if(elementos[i].slot == 'pkDisableCount'){
                            let datos = new AbstractResource();
                            datos.findAll(entidad,tag[i].value).then(data =>{
                                //id nuevo para un ticket
                    ...
                    if(elementos[i].type === 'text'){
                        ...
                        if(elementos[i].placeholder!=null){
                            tag[i].placeholder = elementos[i].placeholder;
                        }  
                        ...
                        tag[i].type = 'email';
                        tag[i].placeholder='ejemplo@correo.com';
                        tag[i].value = elementos[i].value;
        ...
        let extraerJSON= function(tag, metodo){
            ...
            console.log(cadena);
            //convertimos la cadena a un json
            ...
            if(metodo == 'postButton') {
                ...
                alert('Se creo con exito su solicitud');
                form.reset();
                if(bandera == true){
                    bandera = false;
                    tag[indice].value = lenght+1;
                    console.log(tag[indice].value);
                }
